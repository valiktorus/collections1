...
public class GeneralConstants {
    ...
    public static final String TOTAL_COST_0 = " Total cost: 0";
    public static final String TOTAL_COST = "Total cost: ";

    public static final String MEAT = "meat";
    public static final String SPACE = " ";

    public static final String PRINT_FORMAT = "%s = %s%n";
    public static final String FIND_VALUE_FORMAT = "Required value %s in %s: ";
